    ...
    <div className="min-h-screen bg-[#0B0F1A] text-slate-100">
      <div className="mx-auto flex max-w-[1600px]">
        ...
        <main className="flex-1 space-y-5 p-6">
          ...
          {isDemoMode ? (
            <Card className="border-amber-500/40 bg-amber-500/10" title="Demo mode active">
              <p className="text-sm text-amber-100">
                Demo mode active — live AI providers are not connected yet. Add API keys in Vercel Environment Variables to enable real verification.
              </p>
              <p className="mt-3 text-xs font-semibold text-amber-200">Required Vercel Environment Variables:</p>
              <ul className="mt-1 grid gap-1 text-xs text-amber-100 sm:grid-cols-2">
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <Button variant="primary" type="button" disabled={isDemoMode}>
                Copy Answer
              </Button>
              <Button type="button" disabled={isDemoMode}>
                Export
              </Button>
              <Button variant="ghost" type="button" disabled={isDemoMode}>
                Share
              </Button>
            </div>
          </Card>
