...
const visibleModels: ModelName[] = ["GPT", "Gemini", "DeepSeek"];
            ...
            <Card className="border-amber-500/40 bg-amber-500/10 py-3" title="OpenRouter Mode">
              ...
              <details className="mt-2 text-xs text-amber-100">
                ...
                <ul className="mt-1 grid gap-1 sm:grid-cols-2">
                  ...
                  <li>OPENROUTER_MODEL_A</li>
                  <li>OPENROUTER_MODEL_B</li>
                  <li>OPENROUTER_MODEL_C</li>
                  <li>RETRIEVAL_PROVIDER</li>
                  <li>WEB_RETRIEVAL_API_KEY (optional)</li>
                </ul>
              </details>
            </Card>
          ) : null}
                  ...
                  >
                    ...
                    <p className="text-xs leading-5 text-slate-300">
                      {isLoading
                        ? "Verifying response..."
                        : isDemoMode
                          ? "Model unavailable. Add OPENROUTER_API_KEY in Vercel."
                          : isSuccess
                            ? response?.answer ?? "Waiting"
                            : "Model unavailable"}
                    </p>
                    <p className="mt-3 text-[11px] text-slate-400">Source: {isSuccess ? "OpenRouter" : "Unavailable"}</p>
                  </article>
                );
              })}
            </div>
