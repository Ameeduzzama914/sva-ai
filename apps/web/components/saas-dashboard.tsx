            ...
            <Card title="Evidence Panel">
              {isDemoMode ? (
                ...
                <div className="space-y-3 text-xs">
                  <p className="text-slate-400">Sources analyzed: {evidenceSnippets.length} · Snippets extracted: {evidenceSnippets.length} · Retrieval: success</p>
                ...
                <p className="text-xs text-slate-400">
                  {isLoading ? "Searching web... analyzing evidence... comparing sources... generating verdict..." : "Evidence retrieval unavailable."}
                </p>
              )}
            </Card>
