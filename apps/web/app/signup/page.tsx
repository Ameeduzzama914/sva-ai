...
export default function SignUpPage() {
  return <div className="min-h-screen bg-[#070b14] text-slate-100"><MarketingNav />
    <main className="grid min-h-[calc(100vh-64px)] place-items-center px-4 py-10">
      <Card className="w-full max-w-md border-violet-500/30 bg-slate-950/80" title="Create your SVA account" subtitle="Start with the free plan and upgrade anytime.">
        <form className="space-y-3">
          ...
          <input className="w-full rounded-xl border border-slate-700 bg-slate-950 p-3 text-sm" placeholder="Confirm password" type="password" />
