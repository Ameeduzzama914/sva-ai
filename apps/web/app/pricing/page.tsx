...
const plans = [
  { key: "free", name: "Free", price: "₹0", description: "10 verifications/day · 3 AI comparisons · basic evidence retrieval" },
  ...
  { key: "plus", name: "Plus", price: "₹999/month", description: "unlimited verifications · advanced models · priority verification · export/share tools · advanced evidence engine", comingSoon: true }
] as const;
