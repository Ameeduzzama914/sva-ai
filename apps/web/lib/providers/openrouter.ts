...
export const OPENROUTER_MODELS: OpenRouterModelConfig[] = [
  { name: "Model A", id: process.env.OPENROUTER_MODEL_A || "openrouter/free" },
  { name: "Model B", id: process.env.OPENROUTER_MODEL_B || "openrouter/free" },
  { name: "Model C", id: process.env.OPENROUTER_MODEL_C || "openrouter/free" }
];
