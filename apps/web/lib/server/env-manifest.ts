...
export const ENVIRONMENT_VARIABLES: EnvironmentVariableDefinition[] = [
  ...
  { name: "RAZORPAY_CONTROLLED_LIVE_TEST_ENABLED", group: "razorpay", required: false, vercelProductionRequired: false, clientVisible: false, description: "Optional fail-closed switch for one allowlisted live-payment smoke test account." },
  { name: "RAZORPAY_CONTROLLED_LIVE_TEST_EMAIL", group: "razorpay", required: false, vercelProductionRequired: false, clientVisible: false, description: "Optional server-only email allowlist for controlled live-payment pricing." },
  { name: "RAZORPAY_CONTROLLED_LIVE_TEST_EXPIRES_AT", group: "razorpay", required: false, vercelProductionRequired: false, clientVisible: false, description: "Optional ISO-8601 expiry for controlled live-payment pricing." },
